  ...
  return (
    ...
    >
      ...
      <Box className="senderClientData" sx={{ display: "flex", width: "80%" }}>
        ...
        <Box sx={{ width: "50%" }}>
          <Typography className="textStyle" sx={{ fontWeight: 600 }} component="h1" variant="h6" >Client</Typography>
          <Typography mt={1}>Name:-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{selectedClient.name}</Typography>
          <Typography mt={1}>Company:-&nbsp;&nbsp;&nbsp;&nbsp;{selectedClient.companyName}</Typography>
        </Box>
      </Box>

      <Box sx={{ width: "80%", display: "flex" }} className="senderClientData clientDate">
        <Typography mt={1} sx={{ width: "50%" }}>Invoice Date:- {invoiceDetails?.invoicedate}</Typography>
        <Typography mt={1}>Due Date:- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{invoiceDetails?.duedate}</Typography>
      </Box>
      <Box mt={3}>
